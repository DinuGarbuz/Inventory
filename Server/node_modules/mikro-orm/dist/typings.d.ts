...
export declare type WrappedEntity<T, PK extends keyof T> = IWrappedEntity<T, PK> & AnyEntity<T, PK>;
export declare type IdEntity<T extends {
    id: number | string | bigint;
}> = AnyEntity<T, 'id'>;
export declare type UuidEntity<T extends {
    uuid: string;
}> = AnyEntity<T, 'uuid'>;
export declare type MongoEntity<T extends {
    _id: IPrimaryKey;
    id: string;
}> = AnyEntity<T, 'id' | '_id'>;
